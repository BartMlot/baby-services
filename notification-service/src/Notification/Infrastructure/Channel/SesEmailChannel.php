...
/**
 * Delivers email notifications via AWS Simple Email Service.
 * IAM user requires ses:SendEmail and ses:SendRawEmail permissions.
 */
final class SesEmailChannel implements NotificationChannelInterface
{
    ...
    public function send(NotificationContext $context): void
    {
        ...
        try {
            ...
            throw new \RuntimeException(
                sprintf('[SES] Failed to send "%s" to %s: %s', $context->type->value, $context->email, $e->getMessage()),
                previous: $e,
            );
        }
    }
